...
We are interested in the life history and population status for each of the two populations. We are also curious how these variables compare between populations.
...
Pop1_Eigen = eigen(Mat.1, only.values = F)
Pop1_Eigen$values[1]
